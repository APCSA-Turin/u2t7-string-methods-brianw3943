  ...
  */
  ...
  public String removeCharacter(String myString, int removeIdx) {
    if (removeIdx>=myString.length()) {
      ...
      String front = myString.substring(0, removeIdx);
      String back = myString.substring(removeIdx + 1, myString.length());
      return front + back;
    }
  ...
  */
  public String insertAt(String orig, String insertText, String searchStr) {
    if (orig.contains(searchStr)) {
      ...
      String firstHalf = orig.substring(0, idx);
      String secondHalf = orig.substring(idx);
